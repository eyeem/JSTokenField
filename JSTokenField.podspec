...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/eyeem/JSTokenField"
  ...
  s.author             = { "EyeEm" => "" }
  # Or just: s.author    = "EyeEm"
  # s.authors            = { "EyeEm" => "" }
  # s.social_media_url   = "http://twitter.com/EyeEm"
  ...
  s.source       = { :git => "https://github.com/eyeem/JSTokenField.git", :branch => "eyeem-modifications" }
  ...
  s.source_files  = "Classes", "JSTokenField/JS*.{h,m}"
